...
#' if (suppressWarnings(require(lsmeans))) message('lsmeans loaded correctly') else
#' message("please install package 'lsmeans' from the tools menu or by using install.packages('lsmeans')" )
